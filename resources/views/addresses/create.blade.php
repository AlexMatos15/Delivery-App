...
@section('content')
    <div class="client-container">
        <div class="client-section">
            <h2 class="client-section-title">📍 Adicionar Novo Endereço</h2>

            <form method="POST" action="{{ route('addresses.store') }}" class="client-form">
                @csrf
                ...
                <div class="client-form-group">
                    ...
                    <textarea id="reference" name="reference" rows="2" 
                              ...
                              placeholder="Perto da padaria, prédio azul, etc.">{{ old('reference') }}</textarea>
                    @error('reference')
                        <span class="client-form-error">{{ $message }}</span>
                    @enderror
                </div>
